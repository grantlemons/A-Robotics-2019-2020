...
public class Brain {
    ...
    public void autonomousBlue() {
        // startup
        hand.close();
        drivetrain.forwardDistance(13, 0.9);
        ...
        while(!approachSkyStoneBlue()) {
            ...
            if (elapsed>maxTime) {
                drivetrain.strafeDistance(10, 0.9);
                drivetrain.forwardDistance(12, 0.9);
                while(!drivetrain.setHeading(90));
                toRelativeBlockPosition(-1);
                //drive.strafeDistance(, 0.2);?
                drivetrain.forwardToColorNoStop("blue", 0.9, 90);
                drivetrain.forwardDistance(-2, 0.9);
                //drivetrain.forwardToColorNoStop("red", 0.9, -90);
                drivetrain.drive(0, 0, 0);
                return;
            }
        }
        ...
        drivetrain.forwardDistance(-1, 0.7);
        ...
        drivetrain.forwardDistance(4, .6);
        //try {Thread.sleep(500);} catch(InterruptedException ule) {}
        toRelativeBlockPosition(-1);
        hand.open();
        ...
        toRelativeBlockPosition(1);
        drivetrain.strafeDistance(-4, 0.9);
        drivetrain.forwardDistance(23, 0.9);
        toRelativeBlockPosition(-1);
        hand.open();
        try {Thread.sleep(500);} catch(InterruptedException ule) {}
        //drivetrain.forwardDistance(-2, 0.9);
        ...
        drivetrain.forwardDistance(3, 0.8);
    ...
    public void parkBlue(string side) {
        toRelativeBlockPosition(-1);
        while (!drivetrain.setHeading(0))
        if (side == "inside") drivetrain.strafeDistance(26, 0.75);
        if (side == "outside") {}
        forwardToColorNoStop("blue", 1, 0);
    }
    ...
    public void autonomousRed() {
        ...
        while(!approachSkyStoneRed()) {
            ...
            if (elapsed>maxTime) {
                ...
                toRelativeBlockPosition(-1);
                //drive.strafeDistance(, 0.2);?
                //drivetrain.forwardToColorNoStop("blue", 1, 90);
                drivetrain.forwardToColorNoStop("red", 1, -90);
                drivetrain.forwardDistance(-2, 0.9);
                drivetrain.drive(0, 0, 0);
                return;
            }
        ...
        /*// if foundation moved to building site
        toRelativeBlockPosition(1);
        drivetrain.strafeDistance(4, 0.8);
        drivetrain.forwardDistance(23, 0.9);
        toRelativeBlockPosition(-1);
        hand.open();
        try {Thread.sleep(500);} catch(InterruptedException ule) {}
        //drivetrain.forwardDistance(-2, 0.8);
        drivetrain.strafeDistance(-4, 0.9);
        //*/
        ...
        drivetrain.forwardDistance(3, 1);
